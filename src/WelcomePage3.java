 ...
 * @author HP
 */
public class WelcomePage3 extends javax.swing.JFrame {

    /**
     * Creates new form WelcomePage3
     */
    public WelcomePage3() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Welcome to Unity Trust Bank");

        jLabel3.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        jLabel3.setText("Your Account Number is:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        OptionsPage4 o = new OptionsPage4(x);
        o.setVisible(true);
        setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WelcomePage3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WelcomePage3().setVisible(true);
            }
        });
    }
